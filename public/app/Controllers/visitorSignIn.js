(function() {
  ...
  app.controller('visitorSignIn', ["$scope", "$rootScope", "$http", "Auth", "$location", "$firebaseArray", "getAuthData", "$firebaseObject",
    function($scope, $rootScope, $http, Auth, $location, $firebaseArray, getAuthData, $firebaseObject) {
